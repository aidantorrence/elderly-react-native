...
function LifeCalendarTwo ({ navigation, route }) {
    ...
    function handlePress(item) {
        ...
        navigation.navigate('LifeCalendarThree',route.params)
      }
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.body}>
                <Text style={styles.midText}>{route.params * 12} months</Text>
            </View>
            ...
            <View style={styles.bottom}>
                <TouchableOpacity style={[styles.button, styles.continue]} onPress={handlePress}>
                    <Text style={styles.buttonText} >In Weeks</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    )
...
function Cell () {
    return <View style={styles.cell}>
        {new Array(12).fill(0).map((el,idx) => <View key={idx} style={styles.smallCell}></View>)}
    </View>
}
